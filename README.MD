...
- `deletes_files` : Delete files that are greater than or equal to n days old.
...
- `--n_days`: The minimum age of files (in days) of files to be deleted, applicable only when using `delete_files`.
